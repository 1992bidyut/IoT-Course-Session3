...
if (count($rawData)>0) {
	...
	$userID=$rawData['id'];
	$insertSwitchQuery="INSERT INTO switchstate(state, switchid, user_id) VALUES ('0','$devide_id','$userID')";
	$insertExecute=mysqli_query($connect,$insertSwitchQuery); //execute query in database
